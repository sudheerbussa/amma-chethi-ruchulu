...
## Supporting keywords (shipped as topic pages)
...
## Research checklist (each batch)

1. Google primary + supporting; note top weaknesses  
...
| Month | Impressions | Clicks | Top query | Pages added | Notes |
|-------|-------------|--------|-----------|-------------|-------|
| | | | | | |
